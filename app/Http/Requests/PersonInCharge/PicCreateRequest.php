...
class PicCreateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'data.*.departement' => 'sometimes|string|max:25',
    ...
    public function messages(): array
    {
        return [
            ...
            'data.*.departement.string' => 'Each department must be a string.',
            'data.*.departement.max' => 'Each department may not be greater than 25 characters.',
