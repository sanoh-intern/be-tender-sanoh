...
class ProjectHeaderCreateRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'project_attach.required' => 'The project attachment is required.',
            'project_attach.mimes' => 'The project attachment must be a file of type: pdf.',
            'project_attach.max' => 'The project attachment may not be greater than 5000 kilobytes.',
